                ...
                def mainMenu(){
                    ...
                    if(choice == 1){
                        ...
                        def userLogIn(){
                            ...
                            log.write("Executing 'SELECT COUNT(*) FROM payroll.admin_accounts WHERE user_name='"+userName+"' AND password='"+userPassword+"');\n")
                        ...
                        def userMenu(){
                            ...
                            println("")
                            println(" (3) Countries with the highest fully vaccinated people have lower total deaths")
                            println("")
                            println(" (4) Population density compared to total deaths")
                            println("")
                            println(" (5) Total deaths and hospital_beds_per_thousand")
                            println("")
...
/**
                        def method3():Unit={
                                println(" Countries with the highest fully vaccinated people have lower total deaths")
